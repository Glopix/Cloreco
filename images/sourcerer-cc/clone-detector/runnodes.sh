...
# get threshold from 3rd argument or config file or set it to 8 (80%) if it does not exist in the config file
source "${rootPATH}/sourcerer-cc.properties"
threshold="${3:-${SIMILARITY_THRESHOLD:-8}}"
