#!/usr/bin/env bash
# runner script for DrDupLex (https://github.com/tronicek/DrDupLex)
...
CONFIG_FILE_ORIG="${MAIN_DIR}/drDupLex-mounted.config"
CONFIG_FILE="${MAIN_DIR}/drDupLex.config"
KEY="sourceDir"
...
# execute DrDupLex-1.0 with drdup.config configuration file,
# redirect and append both stdout and stderr to $OUTPUT_TARGET
java -jar target/DrDupLex-1.0-jar-with-dependencies.jar "$CONFIG_FILE"  &>> $OUTPUT_TARGET    || exit 1
